    ...
    <>
      <div className="border border-border p-1 hover:scale-95 transitions relative rounded overflow-hidden">
        ...
        <div className="absolute flex-btn gap-2 bottom-0 right-0 left-0 bg-main bg-opacity-60 text-white px-4 py-3">
          ...
          <button
            onClick={() => LikeMovie(movie, likeMoviesDispatch, favMoviesDispatch, userInfo, keycloak)}
          ...
          <button
            onClick={() => IgnoreMovie(movie, ignoreMoviesDispatch, ignoredDispatch, userInfo, keycloak)}
          ...
          <button
            onClick={() => AddToWatchList(movie, addToWatchlistDispatch, watchlistDispatch, userInfo, keycloak)}
